...
import { ArrowLeft, Mail, Lock, LogIn, Anchor } from 'lucide-react';
        ...
        >
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-xs font-semibold text-brand-yellow hover:text-brand-yellow-hover transition-colors">Lupa Password?</a>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <div className="bg-soft-gray p-6 text-center border-t border-gray-100 mt-2">
            <p className="text-sm text-gray-600 font-light">
              Belum memiliki akun?{' '}
              <a href="#" className="font-semibold text-brand-yellow hover:text-brand-yellow-hover transition-colors">
                Daftar sekarang
              </a>
            </p>
          </div>
